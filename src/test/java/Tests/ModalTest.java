...
//        modalPage.closeButtonUsingEscape();
        ...
        // Homework, inchide fereastra de modal prin click inafara ferestrei, vezi metoda clickOutsideTheModal din ModalPage.java
        modalPage.openModal();
        modalPage.closModalByClickOutsideTheModal();
    }
}
