...
public class AthleteApp
{
    public static void main(String[] args) {
        BasketballPlayer kobe = new BasketballPlayer("Kobe Bryant", "Black Mamba", 1978, "Lakers", 83.7, 25.0, 1374);
        BasketballPlayer jordan = new BasketballPlayer("Michael Jordan", "MJ", 1963, "Chicago Bulls", 83.5, 30.1, 1072);
        BasketballPlayer magic = new BasketballPlayer("Erwin Johnson", "Magic", 1959, "Lakers", 84.8, 19.5, 906);
        ...
        FootballPlayer ed = new FootballPlayer("Ed Brady", "Ed Terrific", 1979, "New England", 265, 8988,  4377);
